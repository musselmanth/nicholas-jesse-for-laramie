    ...
    >
      ...
      <div className={styles.heroContainer}>
        ...
        <div className={styles.leftContent}>
          ...
          <h2 className={styles.subtitle}>For Laramie City Council, Ward 1</h2>
          <p className={styles.pitch}>
            Cultivating community, rooted in Laramie.
          </p>

          <div className={styles.actions}>
            <Link href="/volunteer" className={styles.primaryBtn}>Get Involved</Link>
            <Link href="/donate" className={styles.secondaryBtn}>Donate</Link>
          </div>
